...
const buildItems = (clientIds) => [
  // ---- PARRILLA ----
  {
    ...
    category: 'Parrilla',
    image: 'https://picsum.photos/seed/bife1/400/300',
    link: '#menu',
  ...
  },
  {
    ...
    category: 'Parrilla',
    image: 'https://picsum.photos/seed/asado1/400/300',
    link: '#menu',
    clientId: clientIds[0],
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    category: 'Parrilla',
    image: 'https://picsum.photos/seed/entrana1/400/300',
    link: '#menu',
  ...
  },
  {
    ...
    category: 'Parrilla',
    image: 'https://picsum.photos/seed/vacio1/400/300',
    link: '#menu',
    clientId: clientIds[1],
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    category: 'Parrilla',
    image: 'https://picsum.photos/seed/parrillada1/400/300',
    link: '#menu',
    clientId: clientIds[0],
    createdAt: new Date(),
    updatedAt: new Date()
  ...
  // ---- ENTRANTES ----
  {
    ...
    category: 'Entrantes',
    image: 'https://picsum.photos/seed/provoleta1/400/300',
    link: '#menu',
    clientId: clientIds[0],
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    category: 'Entrantes',
    image: 'https://picsum.photos/seed/empanadas1/400/300',
    link: '#menu',
    clientId: clientIds[1],
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    category: 'Entrantes',
    image: 'https://picsum.photos/seed/fiambres1/400/300',
    link: '#menu',
    clientId: clientIds[0],
    createdAt: new Date(),
    updatedAt: new Date()
  ...
  // ---- GUARNICIONES ----
  {
    ...
    image: 'https://picsum.photos/seed/papas1/400/300',
    link: '#menu',
    clientId: clientIds[1],
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    category: 'Guarniciones',
    image: 'https://picsum.photos/seed/ensalada1/400/300',
    link: '#menu',
    clientId: clientIds[0],
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    category: 'Guarniciones',
    image: 'https://picsum.photos/seed/pure1/400/300',
    link: '#menu',
    clientId: clientIds[1],
    createdAt: new Date(),
    updatedAt: new Date()
  ...
  // ---- BEBIDAS ----
  {
    ...
    category: 'Bebidas',
    image: 'https://picsum.photos/seed/vino1/400/300',
    link: '#menu',
    clientId: clientIds[0],
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    category: 'Bebidas',
    image: 'https://picsum.photos/seed/cerveza1/400/300',
    link: '#menu',
    clientId: clientIds[1],
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    category: 'Bebidas',
    image: 'https://picsum.photos/seed/gaseosa1/400/300',
    link: '#menu',
    clientId: clientIds[0],
    createdAt: new Date(),
    updatedAt: new Date()
  ...
  // ---- POSTRES ----
  {
    ...
    category: 'Postres',
    image: 'https://picsum.photos/seed/flan1/400/300',
    link: '#menu',
    clientId: clientIds[1],
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    category: 'Postres',
    image: 'https://picsum.photos/seed/panqueques1/400/300',
    link: '#menu',
    clientId: clientIds[0],
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    ...
    category: 'Postres',
    image: 'https://picsum.photos/seed/budin1/400/300',
    link: '#menu',
    clientId: clientIds[1],
    createdAt: new Date(),
    updatedAt: new Date()
